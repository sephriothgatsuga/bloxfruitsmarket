...
module.exports = { 
    ...
    run: async (bot, message, args) => {
        ...
        var inv = new MessageEmbed()
            ...
            .addField('Bot Invite Link', 'To invite the bot into your server: [Click Here](https://discord.com/api/oauth2/authorize?client_id=719836513629765752&permissions=477184&scope=bot)')
